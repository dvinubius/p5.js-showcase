...
function setup() {
	...
	const pHue = createElement('p', legendHue + Math.round(bg.h));
	const pLum = createElement('p', legendLum + Math.round(bg.l));
	const pSat = createElement('p', legendSat + Math.round(bg.s));
